...
{
    protected $name          = 'Datenbank-Voraussetzungen';
    protected $requiredState = 'InnoDB, UTF-8';
    protected $description   = 'Für JTL-Shop ist Datenbankunterstützung für InnoDB und UTF-8 erforderlich.';
