...
class MailService extends AbstractService
{
    ...
    /**
     * @param MailRepository|null     $repository
     * @param AttachmentsService|null $attachmentsService
     */
    public function __construct(
        protected ?MailRepository $repository = null,
        protected ?AttachmentsService $attachmentsService = null
    ) {
        $this->repository         = $this->repository ?? new MailRepository();
        $this->attachmentsService = $this->attachmentsService ?? new AttachmentsService();
    }
     ...
     */
    public function queueMail(MailObject $mailObject): array
    {
        $result = true;
