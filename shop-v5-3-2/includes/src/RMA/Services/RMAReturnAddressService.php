...
{
    /**
     * @param RMAReturnAddressRepository|null $RMAReturnAddressRepository
     */
    public function __construct(public ?RMAReturnAddressRepository $RMAReturnAddressRepository = null)
    {
        $this->RMAReturnAddressRepository = $RMAReturnAddressRepository ?? new RMAReturnAddressRepository();
    }

    /**
     * @param RMADomainObject $rma
     * @return RMAReturnAddressDomainObject|null
    ...
    public function getReturnAddress(RMADomainObject $rma): ?RMAReturnAddressDomainObject
    {
        ...
        if ($result === null && $rma->id > 0) {
            $returnAddress = $this->RMAReturnAddressRepository->filter(['rmaID' => $rma->id]);
    ...
    public function returnAddressFromDeliveryAddressTemplateID(
        ...
        $deliveryAddressTemplate = $this->RMAReturnAddressRepository->createFromDeliveryAddressTemplate(
