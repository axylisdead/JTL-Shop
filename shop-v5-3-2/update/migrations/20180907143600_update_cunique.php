...
class Migration_20180907143600 extends Migration implements IMigration
{
    ...
    public function up()
    {
        $this->execute('ALTER TABLE `twarenkorbperspos` CHANGE COLUMN `cUnique` `cUnique` VARCHAR(255) COLLATE utf8mb4_unicode_ci NOT NULL');
        $this->execute('ALTER TABLE `twarenkorbpos` CHANGE COLUMN `cUnique` `cUnique` VARCHAR(255) COLLATE utf8mb4_unicode_ci NOT NULL');
    }
