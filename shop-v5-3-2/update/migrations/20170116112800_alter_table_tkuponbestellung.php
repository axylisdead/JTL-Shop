...
class Migration_20170116112800 extends Migration implements IMigration
{
    ...
    public function up()
    {
        $this->execute(
            "ALTER TABLE `tkuponbestellung`
                ADD `kKunde` INT, 
                ADD `cBestellNr` VARCHAR(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
                ADD `fGesamtsummeBrutto` DOUBLE NOT NULL DEFAULT 0,
                ADD `fKuponwertBrutto` DOUBLE NOT NULL DEFAULT 0,
                ADD `cKuponTyp` ENUM('prozent','festpreis','versand','neukunden') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
