...
class Migration_20181129151242 extends Migration implements IMigration
{
    ...
    public function down()
    {
        ...
        $this->execute("CREATE TABLE `tkuponneukunde` (
                          ...
                          `cDatenHash`     VARCHAR(255) COLLATE utf8mb4_unicode_ci NOT NULL,
                          `dErstellt`      DATETIME NOT NULL,
                          `cVerwendet`     VARCHAR(1) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'N',
                          PRIMARY KEY (`kKuponNeukunde`),
                          KEY `cEmail` (`cEmail`,`cDatenHash`)
                        ) ENGINE=InnoDB CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci");

        $this->execute("ALTER TABLE `tkuponbestellung`
                          CHANGE COLUMN `cKuponTyp` `cKuponTyp` ENUM('prozent', 'festpreis', 'versand', 'neukunden') COLLATE utf8mb4_unicode_ci DEFAULT NULL");
