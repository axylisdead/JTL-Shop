...
if (isset($queryResult)) {
    ...
    if ($queryResult->ts_ReviewStickerAktiv == "1" && $queryResult->ts_ReviewStickerModus == "bewertung" && $queryResult->ts_ReviewStickerPosition == "3" && Shop::getPageType() != PAGE_ARTIKEL) {
