    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" id="lpa-simple-path-form" target="_blank" action="https://sellercentral-europe.amazon.com/hz/me/sp/redirect?ld=SPEXDEAPA-JTLPL">
                ...
                <button type="submit" value="submit" class="btn btn-primary"><i class="fa fa-external-link"></i> Amazon Pay Account registrieren</button>
            </form>
        </div>
        <div class="panel-body">
            <p style="font-weight: bold;">Sie haben bereits einen Amazon Pay Account?</p>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" id="lpa-account-settings-form" action="{$pluginAdminUrl}cPluginTab=Einstellungen%20Account">
                ...
                <div class="item">
                    <div class="name">
                        <label for="mws_environment">Sandbox/Produktion</label>
                    </div>
                ...
                <div class="item">
                    ...
                    <div id="lpa_ipn_url">
                        {$s360_lpa_config.lpa_ipn_url} (<small><a href="{$s360_lpa_config.lpa_ipn_url}?lpacheck" target="_blank">H&auml;ndler-URL pr&uuml;fen</a></small>)
                    </div>
                </div>
                <div class="item">
                    <div class="name">
