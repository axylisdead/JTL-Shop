...
<div id="settings">
    ...
    <div class="s360-video s360-video-general">
        ...
        <div class="s360-video-container">
            <iframe width="560" height="315" data-src="https://redirect.solution360.de/?r=lpa4v1vid_intro" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form method="post" id="lpa-simple-path-return-form"
                ...
                <ol class="s360-ordered-list">
                    ...
                    <li>
                        Falls Sie keine Client-ID sehen, gehen Sie zun&auml;chst in den Bereich "Integration" -&gt; "Integration Central" und klicken Sie unten auf <b>Client-ID/Store-ID erstellen</b>. Folgen Sie dann erneut den obigen Schritten.
                    </li>
            ...
            <form method="post" id="lpa-account-settings-form"
                ...
                <table class="table s360-borderless">
                    ...
                    <tr>
                        <td><label for="mws_secret_key">MWS Secret Key{if isset($s360_lpa_config.mws_secret_key) && !empty($s360_lpa_config.mws_secret_key)}<span class="text-success"> (vorhanden)</span>{/if}</label></td>
                        <td><input id="mws_secret_key" class="form-control" type="password" name="mws_secret_key"
                                   value=""
                                   size="60"/></td>
                    </tr>
                    <tr>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="s360-video">
                <div class="s360-video-title"><i class="fa fa-eye"></i>&nbsp;Sehen Sie sich das Video an.</div>
                <div class="s360-video-container">
                    <iframe width="560" height="315" data-src="https://redirect.solution360.de/?r=lpa4v1vid_ipn" frameborder="0"
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="s360-video">
                <div class="s360-video-title"><i class="fa fa-eye"></i>&nbsp;Sehen Sie sich das Video an.</div>
                <div class="s360-video-container">
                    <iframe width="560" height="315" data-src="https://redirect.solution360.de/?r=lpa4v1vid_loginapp_origin" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div>
            ...
            <ol class="s360-ordered-list">
                ...
                <li>
                    Gehen Sie in den Bereich "Integration" -&gt; "Integration Central" -&gt; "Client-IDs/Store-IDs verwalten"
                </li>
                <li>
                    Klicken Sie auf <b>Client-IDs/Store-IDs anzeigen</b>.
                </li>
                <li>
                    Klicken Sie rechts auf <b>Bearbeiten</b>.
                </li>
                <li>F&uuml;gen Sie die kopierte URL im Bereich <b>Zul&auml;ssige JavaScript-Urspr&uuml;nge</b> ein und speichern Sie.</li>
            </ol>
        </div>
    </div>
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="s360-video">
                <div class="s360-video-title"><i class="fa fa-eye"></i>&nbsp;Sehen Sie sich das Video an.</div>
                <div class="s360-video-container">
                    <iframe width="560" height="315" data-src="https://redirect.solution360.de/?r=lpa4v1vid_loginapp_return" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            </div>
            <div>
            ...
            <ol class="s360-ordered-list">
                ...
                <li>F&uuml;gen Sie jede URL im Bereich "Zul&auml;ssige R&uuml;ckleitungs-URLs" ein.</li>
