...
try {
    ...
    if(isset($oPlugin->oPluginEinstellungAssoc_arr[S360_LPA_CONFKEY_ADVANCED_STORNO]) && $oPlugin->oPluginEinstellungAssoc_arr[S360_LPA_CONFKEY_ADVANCED_STORNO] === 'NM') {
        // do nothing more - we sent the mail, but do not cancel the order against Amazon Pay
        Jtllog::writeLog('LPA: WaWi-Abgleich: Beende nach Storno-Email-Versand, da nicht automatisch storniert werden soll.', JTLLOG_LEVEL_DEBUG);
        return;
    }
