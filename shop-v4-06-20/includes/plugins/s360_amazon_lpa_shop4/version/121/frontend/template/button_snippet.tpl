...
<div class="{$lpa_button_type_class}{if $lpa_button_type_class !== 'lpa-pay-button'} text-center{/if}{if isset($lpa_express_button) && $lpa_express_button} lpa-pay-button-express{/if}" id="AmazonPay{if isset($lpa_express_button) && $lpa_express_button}Express{/if}Button_{$lpa_button_idx}{if isset($lpa_express_button) && $lpa_express_button}_{$lpa_timestamp_tag}{/if}" {if $lpa_general_hiddenbuttons_active == 1}style="visibility:hidden;display:none;"{/if}>
    {if isset($lpa_express_button) && $lpa_express_button}
        <div class="text-danger lpa-pay-button-express-feedback"></div>
    {/if}
    {if $lpa_button_type_class === 'lpa-pay-button'}
        <i class="fa fa-question-circle-o lpa-tooltip" data-lpa-tooltip-text="{$lpa_button_tooltip}"></i>
    {/if}
</div>
