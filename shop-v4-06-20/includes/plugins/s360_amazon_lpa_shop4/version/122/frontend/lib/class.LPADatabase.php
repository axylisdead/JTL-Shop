...
class LPADatabase {
        ...
        try {
            ...
            if (null !== $rechnungsadresse && $this->oPlugin->oPluginEinstellungAssoc_arr[S360_LPA_CONFKEY_ADVANCED_USE_BILLING_ADDRESS] === 'Y') {
                ...
                if ((int)$kRechnungsadresse > 0) {
                    ...
                    $neueRechnungsadresse->cAdressZusatz = isset($rechnungsadresse->cAdressZusatz) ? $rechnungsadresse->cAdressZusatz : '';
                    $neueRechnungsadresse->cFirma = isset($rechnungsadresse->cFirma) ? $rechnungsadresse->cFirma : '';
    ...
    public function isOrderPaidCompletely($orid) {
        Jtllog::writeLog("LPA: OrderPaidCompletely wird fuer ORID $orid ausgeführt.", JTLLOG_LEVEL_DEBUG);
        ...
        if($targetAmount <= (float) 0) {
            ...
            Jtllog::writeLog("LPA: OrderPaidCompletely Order Gesamtsumme <= 0, gebe false zurück.", JTLLOG_LEVEL_DEBUG);
            return false;
        }
