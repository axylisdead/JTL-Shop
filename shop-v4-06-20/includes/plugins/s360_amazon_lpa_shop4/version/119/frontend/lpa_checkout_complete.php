...
Shop::set('lpa_plugin_page', 'checkout_complete');
 ...
 */
$session->cleanUp();
if(isset($_SESSION['lpa_basket_checksum'])) {
    unset($_SESSION['lpa_basket_checksum']);
}

if (empty($_SESSION['Kunde']) || (int) $_SESSION['Kunde']->kKunde == 0) {
