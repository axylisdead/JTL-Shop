                ...
                <table class="list table table-hover">
                    ...
                    {foreach $orders as $order}
                        ...
                        <tr class="text-vcenter">
                            ...
                            <th class="text-right">
                                {if $finance->paymentId == $order->kZahlungsart}
                                    {if $order->cStatus > 0 && $order->cStatus < 3}
                                        <a href="plugin.php?s1={$pagination->nAktuelleSeite}&kPlugin={$oPlugin->kPlugin}&capture={$order->kBestellung}{$hash}" class="btn btn-sm btn-default">Capture</a>
                                    {/if}
                                {/if}
                            </th>
                        </tr>
